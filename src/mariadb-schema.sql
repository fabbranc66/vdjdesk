...
CREATE TABLE IF NOT EXISTS library_databases (
    ...
    record_count INT NOT NULL DEFAULT 0, status VARCHAR(30) NOT NULL DEFAULT 'pending', message LONGTEXT NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS e_duplicate_scans (
    ...
    exact_groups INT NOT NULL DEFAULT 0, normalized_groups INT NOT NULL DEFAULT 0, message LONGTEXT NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
