  ...
  <main>
    ...
    <section class="view" id="view-library">
      ...
      <div class="library-simple-filters">
        ...
        <details><summary>Filtri avanzati</summary><div class="filter-row"><input id="filter-bpm" type="number" placeholder="BPM"><input id="filter-key" placeholder="Key / Camelot"><input id="filter-genre" placeholder="Genere"><input id="filter-year" type="number" placeholder="Anno"><select id="filter-quality"><option value="">Qualità: tutte</option><option value="below">Audio sotto standard</option><option value="standard">Audio standard o superiore</option><option value="video">Video</option></select><button class="button ghost" id="clear-filters">Azzera filtri</button></div></details>
      </div>
    ...
    <section class="view" id="view-playlists">
      ...
      <div class="library-simple-filters" id="playlist-filters"><label><span>PLAYLIST VIRTUALDJ</span><select id="playlist-select"><option value="">Lettura playlist…</option></select></label><details><summary>Filtri avanzati</summary><div class="filter-row"><input id="playlist-bpm" type="number" placeholder="BPM"><input id="playlist-key" placeholder="Key / Camelot"><input id="playlist-genre" placeholder="Genere"><input id="playlist-year" type="number" placeholder="Anno"><select id="playlist-quality"><option value="">Qualità: tutte</option><option value="below">Audio sotto standard</option><option value="standard">Audio standard o superiore</option><option value="video">Video</option></select><button class="button ghost" id="playlist-clear">Azzera filtri</button></div></details></div>
